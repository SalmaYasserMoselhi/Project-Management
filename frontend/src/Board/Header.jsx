...
//                 className="w-full pl-12 pr-6 py-3 text-[15px] border-2 border-gray-100 rounded-xl focus:border-[#897098] focus:ring-0 outline-none transition-all placeholder-gray-400 bg-gray-50 hover:bg-white"
//                 aria-label="Search"
//               />
