...
//                               </span>
//                               <ChevronDown
//                                 className={`ml-2 transition-transform ${roleDropdownOpen === m.id ? 'rotate-180' : ''} text-gray-400`}
//                                 size={18}
//                               />
//                             </button>
//                           </div>
...
//                             aria-label={currentUser && m.user?._id === currentUser._id ? "Leave board" : "Remove member"}
...
//                     )
//                     fetch(`${BASE_URL}/api/v1/boards/user-boards/${boardId}`, {
//                       method: 'PATCH',
...
//               <img src={edit || "/placeholder.svg"} alt="Edit" className="w-4 h-4 cursor-pointer ms-2" />
//             </h1>
//             <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
//               <img src={CalendarBlank || "/placeholder.svg"} alt="Calendar" className="w-4 h-4" /> 20 July
//             </p>
//           </div>
...
//                   <li onClick={handleArchivedClick} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
//                     Archived
//                   </li>
//                   <li
//                     onClick={() => {
...
//         {showArchivedPopup && <ArchivedPopup onClose={() => setShowArchivedPopup(false)} boardId={boardId} />}
...
//   const handleDescriptionBlur = () => setEditingDescription(false)
...
//                   className="text-2xl font-semibold border border-gray-300 rounded-lg px-2 py-1 focus:outline-none focus:ring-0.5 focus:ring-[#6a3b82] bg-white text-[#6a3b82]"
//                   style={{ minWidth: 180 }}
//                 />
//                 <button
//                   onClick={handleSave}
//                   disabled={saving}
//                   className="px-4 py-1 rounded-lg bg-gradient-to-r from-[#4d2d61] to-[#7b4397] text-white text-sm font-medium transition-all hover:shadow-lg hover:scale-[1.01] hover:translate-y-[-2px] disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
//                 >
//                   {saving ? (
//                     <>
...
//                 className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 text-gray-700 focus:outline-none focus:ring-0.5 focus:ring-[#6a3b82] text-sm min-h-[80px]"
//                 rows={2}
...
//                 onClick={handleSave}
//                 disabled={saving}
//                 className="mt-2 px-4 py-1 rounded-lg bg-gradient-to-r from-[#4d2d61] to-[#7b4397] text-white text-sm font-medium transition-all hover:shadow-lg hover:scale-[1.01] hover:translate-y-[-2px] disabled:opacity-50 disabled:cursor-not-allowed flex items-center self-end"
//               >
//                 {saving ? (
//                   <>
//                     <div className="animate-spin h-4 w-4 border-2 border-white border-t-transparent rounded-full mr-2"></div>
...
//               <button className="ml-2 text-gray-400 hover:text-[#6a3b82]" onClick={toggleEditDescription}>
//                 <Edit size={16} />
//               </button>
//             </div>
//           )}
...
//                   {saving ? (
//                     <>
//                       <div className="animate-spin h-4 w-4  border-2 border-white border-t-transparent rounded-full mr-2 p-3"></div>
//                       <span>Saving...</span>
//                     </>
//                   ) : (
//                     <span>Save</span>
...
//           ) : (
//             <div className="flex items-center gap-2 flex-1">
//               <p className="text-gray-600 text-md">{form.description || "No description available"}</p>
//               <button className="ml-2 text-gray-400 hover:text-[#6a3b82]" onClick={toggleEditDescription}>
//                 <Edit size={16} />
//               </button>
//             </div>
...
//                   onBlur={handleNameBlur}
//                   onKeyDown={handleNameKeyDown}
//                   className="text-xl font-semibold text-gray-800 border border-gray-300 rounded-md px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-[#6a3b82] focus:border-transparent transition-all duration-200 bg-white shadow-sm"
//                   style={{ minWidth: '200px' }}
//                 />
//                 <button
//                   onClick={handleSave}
//                   disabled={saving}
//                   className="px-4 py-1 rounded-lg bg-gradient-to-r from-[#4d2d61] to-[#7b4397] text-white text-sm font-medium transition-all hover:shadow-lg hover:scale-[1.01] hover:translate-y-[-2px] disabled:opacity-50 disabled:cursor-not-allowed flex items-center self-end"
//                 >
//                   {saving ? (
//                     <>
//                       <div className="animate-spin h-4 w-4 border-2 border-white border-t-transparent rounded-full mr-2"></div>
...
//                 onBlur={handleDescriptionBlur}
//                 onKeyDown={handleDescriptionKeyDown}
//                 className="w-[70%] text-sm text-gray-700 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#6a3b82] focus:border-transparent transition-all duration-200 bg-white shadow-sm resize-vertical"
//                 rows={3}
//                 placeholder="Add a board description"
//               />
//               <button
//                 onClick={handleSave}
//                 disabled={saving}
//                 className="mt-2 px-4 py-1 -mt-5 rounded-lg bg-gradient-to-r from-[#4d2d61] to-[#7b4397] text-white text-sm font-medium transition-all hover:shadow-lg hover:scale-[1.01] hover:translate-y-[-2px] disabled:opacity-50 disabled:cursor-not-allowed flex items-center self-end"
//               >
//                 {saving ? (
//                   <>
//                     <div className="animate-spin h-4 w-4 border-2 border-white border-t-transparent rounded-full mr-2"></div>
...
const ProjectInfo = ({
  ...
  const membersScrollRef = useRef(null);
  const observerRef = useRef(null);
>>>>>>> 9f7f5d5c225b41bd8b9e5885aea2e1c414ab24d8
