...
const TaskCard = ({ title = "Task", priority, fileCount = 3, commentCount = 5 }) => {
  ...
  return (
    <div className="flex rounded-lg overflow-hidden shadow-lg mb-3 w-full">
      <div className="w-10 bg-[#4D2D61] flex items-center justify-center" style={{ minHeight: "100px" }}>
      ...
      <div className="bg-white text-black p-3 rounded-r-lg flex-grow w-full">
        <div className="flex justify-between items-center">
          ...
          <img src={vector} className="w-[18px] h-[4px] cursor-pointer hover:opacity-70" alt="Options" />
        </div>
        ...
        <div className="flex justify-between items-center mt-4">
          <div className="flex -space-x-2">
            <img src={avatar3} className="w-8 h-8 rounded-full border-2 border-white" alt="avatar" />
            ...
            <img src={addButton} alt="Add" className="w-8 h-8 ms-4 rounded-full border-2 border-white bg-gray-300 cursor-pointer" />
          </div>
