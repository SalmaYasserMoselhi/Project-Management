...
const AddListButton = ({ boardId, onListAdded }) => {
  ...
  return (
    <>
      <div
        className="min-w-[280px] sm:min-w-[300px] h-[40px] max-w-[300px] lg:h-[47px] flex items-center justify-center bg-white rounded-lg shadow-sm cursor-pointer transition button-hover"
