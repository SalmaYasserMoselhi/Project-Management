...
export function setupPopupAnimation(popupRef, backdropRef, isClosing, onAnimationEnd) {
...
export function setupWorkspaceAnimation(popupRef, backdropRef, transitionState, onAnimationEnd) {
  if (!popupRef.current || !backdropRef.current) return

  // Remove existing animation classes
  popupRef.current.classList.remove("workspace-popup-entering", "workspace-popup-exiting")
  backdropRef.current.classList.remove("workspace-backdrop-entering", "workspace-backdrop-exiting")
...
export function setupUserPopupAnimation(popupRef, isOpen, isClosing, onAnimationEnd) {
